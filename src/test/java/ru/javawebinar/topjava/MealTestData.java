...
public class MealTestData {
    ...
    public static final int TEST_MEAL_ID = START_SEQ + 2;

    public static final Meal meal1 = new Meal(TEST_MEAL_ID, LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак", 500);
    ...
    public static final Meal meal7 = new Meal(START_SEQ + 8, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1020);
    public static final Meal meal8 = new Meal(START_SEQ + 9, LocalDateTime.of(2015, Month.MAY, 31, 12, 0), "Обед", 480);
    public static final Meal meal9 = new Meal(START_SEQ + 10, LocalDateTime.of(2015, Month.MAY, 31, 21, 0), "Ужин", 510);
