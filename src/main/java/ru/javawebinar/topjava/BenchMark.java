...
public class BenchMark {
    ...
    */
    ...
    @OutputTimeUnit(TimeUnit.NANOSECONDS)
    @Warmup(iterations = 5)
    public void benchGetFilteredWithExceededByStreamI(ExecutionPlan plan) {

        UserMealsUtil.getFilteredWithExceededByStreamCollector(plan.mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
