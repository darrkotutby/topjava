...
public class UserMealsUtil {
    public static void main(String[] args) {
        ...
        List<UserMeal> list4 = getFilteredWithExceededByStreamCollector(mealList, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    ...
    public static List<UserMeal> getFilteredWithExceededByStreamCollector(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        return mealList.stream()
                .collect(new MedianCollectorTest(caloriesPerDay, startTime, endTime));
    }
